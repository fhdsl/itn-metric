...
get_plot <- function(course_name, web_traffic_overtime, publishdates, titleOI, useylab = FALSE, usexlab = FALSE, xlimMinVal = min(web_traffic_overtime$month_year), xlimMaxVal = max(web_traffic_overtime$month_year), ylimVal = 400){
  ...
  plotOI <- web_traffic_overtime %>% 
    ...
    ggplot2::theme_minimal() +
    ggplot2::theme(axis.text.x=ggplot2::element_text(angle=60, hjust=1),
                   strip.text.x = ggplot2::element_text(size=7), axis.title=element_text(size=9)) +
...
p11 <- get_plot("Choosing Genomics Tools", web_traffic_overtime, publishdates, "Choosing Genomics Tools") #Choosing Genomics Tools

p12 <- get_plot("Computing for Cancer Informatics", web_traffic_overtime, publishdates, "Computing for Cancer Informatics") #Computing for Cancer Informatics

p20 <- get_plot("Documentation and Usability", web_traffic_overtime, publishdates, "Documentation and Usability") #Documentation and Usability

p21 <- get_plot("Advanced Reproducibility", web_traffic_overtime, publishdates, "Advanced Reproducibility") #Advanced Reproducibility

p22 <- get_plot("AI for Efficient Programming", web_traffic_overtime, publishdates, "AI for Efficient Programming", usexlab = TRUE) #AI for Efficient Programming

p23 <- get_plot("GitHub Automation for Scientists", web_traffic_overtime, publishdates, "GitHub Automation for Scientists") #GitHub Automation for Scientists
```
...
layout <- 'ABCDE
           FGH##
           IJKL#'
overall_plot <- wrap_plots(A=p00, B=p01, C=p02, D=p03, E=p04, F=p10, G=p11, H=p12, I=p20, J=p21, K=p22, L=p23, design=layout) +plot_layout(ncol = 5, nrow =3, axes="collect", axis_titles = "collect", guides="collect")
