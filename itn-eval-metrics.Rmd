...
```{r}
ggplot2::ggplot(itcr_course_data, ggplot2::aes(x = reorder(website, -activeUsers), y = activeUsers)) +
...
ggplot2::ggsave(file.path("plots", "itn_course_traffic_plot_by_course.png"), width = 4, height = 2)
```
