...
itcr_course_data <- ga_metrics %>% 
  ...
  dplyr::mutate(website = dplyr::case_when(
    ...
    website == "Documentation and Usability Course" ~ "Documentation and Usability", 
                                           TRUE ~ website))
...
long_df <- itcr_course_data %>% dplyr::select(c("website", 
  ...
  dplyr::mutate(modality = dplyr::case_when(
    modality == "total_leanpub_enrollees" ~ "Total Leanpub Enrollments", 
    modality == "total_coursera_enrollments" ~ "Total Coursera Enrollments",
